...
const handleRestore = async () => {
  ...
  try {
    const response = await $academicYearStore.restoreAcademicYear(props.data.slug)
...
<template>
  <DialogHeader>
    <DialogTitle>Khôi phục năm học</DialogTitle>
    <DialogDescription>
      Bạn có muốn khôi phục năm học <strong>{{ data.name }}</strong> ?
    </DialogDescription>
  </DialogHeader>
