<template>
  <div class="stream-wrapper">
    ...
    <div class="stream-body">
        <div class="btn-left">
            <div class="btn-inner-left">
                <div>Upcoming</div>
                <div>No work due in soon!</div>
        ...
        <div class="btn-right">
            <div class="btn-right">
            <div class="noti">
                <div class="avatar-stream">V</div>
                <div>Announce somthing to your class</div>
            </div>
            <div class="noti">
                <div class="avatar-stream">
                    <svg
...
<script setup>
// Logic hoặc props có thể được thêm vào đây
</script>
